...
namespace CS_demo39
{
    public partial class 修改XElement屬性及節點 : System.Web.UI.Page
    {
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            XElement xml = new XElement("Employees", xmlObj);
            //Update
            XElement element = (from table in xml.Elements("Employee")
                                where ((int)table.Attribute("EmployeeID") == 1)
                                select table).First();

            element.SetAttributeValue("Title","New Title");
