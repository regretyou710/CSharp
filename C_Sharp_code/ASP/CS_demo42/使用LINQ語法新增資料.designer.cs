...
namespace CS_demo42
{
	...
	public partial class 使用LINQ語法新增資料DataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteProducts(Products instance);
		...
		public 使用LINQ語法新增資料DataContext() : 
		...
		public 使用LINQ語法新增資料DataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public 使用LINQ語法新增資料DataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public 使用LINQ語法新增資料DataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public 使用LINQ語法新增資料DataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
