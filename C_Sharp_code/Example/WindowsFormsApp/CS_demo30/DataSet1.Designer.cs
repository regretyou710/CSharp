...
namespace CS_demo30 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(string Name, int Age, string Major) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow FindByNo(int No) {
...
namespace CS_demo30.DataSet1TableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Student] WHERE (([No] = @Original_No) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Major = 1 AND [Major] IS NULL) OR ([Major] = @Original_Major)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([Name], [Age], [Major]) VALUES (@Name, @Age, @Major)" +
                ";\r\nSELECT No, Name, Age, Major FROM Student WHERE (No = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Name] = @Name, [Age] = @Age, [Major] = @Major WHERE (([No] = @Original_No) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Major = 1 AND [Major] IS NULL) OR ([Major] = @Original_Major)));
SELECT No, Name, Age, Major FROM Student WHERE (No = @No)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CS_demo30.Properties.Settings.Default.SchoolConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT No, Name, Age, Major FROM dbo.Student";
        ...
        public virtual int Delete(int Original_No, string Original_Name, global::System.Nullable<int> Original_Age, string Original_Major) {
        ...
        public virtual int Insert(string Name, global::System.Nullable<int> Age, string Major) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, global::System.Nullable<int> Age, string Major, int Original_No, string Original_Name, global::System.Nullable<int> Original_Age, string Original_Major, int No) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, global::System.Nullable<int> Age, string Major, int Original_No, string Original_Name, global::System.Nullable<int> Original_Age, string Original_Major) {
            return this.Update(Name, Age, Major, Original_No, Original_Name, Original_Age, Original_Major, Original_No);
        }
    }
