...
Namespace localWS_VB
    ...
    Partial Public Class WebService1
        ...
        Private getStudentOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.VB_demo34.My.MySettings.Default.VB_demo34_localWS_VB_WebService1
        ...
        '''<remarks/>
        Public Event getStudentCompleted As getStudentCompletedEventHandler
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/getStudent", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function getStudent() As System.Data.DataSet
            Dim results() As Object = Me.Invoke("getStudent", New Object(-1) {})
            Return CType(results(0),System.Data.DataSet)
        End Function
        
        '''<remarks/>
        Public Overloads Sub getStudentAsync()
            Me.getStudentAsync(Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub getStudentAsync(ByVal userState As Object)
            If (Me.getStudentOperationCompleted Is Nothing) Then
                Me.getStudentOperationCompleted = AddressOf Me.OngetStudentOperationCompleted
            End If
            Me.InvokeAsync("getStudent", New Object(-1) {}, Me.getStudentOperationCompleted, userState)
        End Sub
        
        Private Sub OngetStudentOperationCompleted(ByVal arg As Object)
            If (Not (Me.getStudentCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent getStudentCompleted(Me, New getStudentCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.3761.0")>  _
    Public Delegate Sub getStudentCompletedEventHandler(ByVal sender As Object, ByVal e As getStudentCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.3761.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class getStudentCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
