...
namespace CS_demo06
{
    ...
    public partial class AdventureWorks2012Entities : ObjectContext
    {
        ...
        /// </summary>
        /// <param name="territoryID">沒有可用的中繼資料文件。</param>
        public ObjectResult<Nullable<global::System.Int32>> CountOrder(Nullable<global::System.Int32> territoryID)
        {
            ObjectParameter territoryIDParameter;
            if (territoryID.HasValue)
            {
            ...
            return base.ExecuteFunction<Nullable<global::System.Int32>>("CountOrder", territoryIDParameter);
        }
